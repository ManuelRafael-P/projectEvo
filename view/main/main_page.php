...
<div id="text_tittle" class="col-lg-6">
  <h1 class="big-heading">Diseños para que puedas lucir todos los días</h1>
...
<h2 class="font-weight-light section-heading h2title">Productos mas populares</h2>     
...
<div class="row">
    <div class="col ">
        <h2 class="font-weight-light section-heading h2title">Casacas</h2>
    </div>
    <div class="col">
...
<div class="row">
    <div class="col">
        <h2 class="font-weight-light section-heading h2title">Conjunto</h2>
    </div>
    <div class="col">
        <div class="float-right mt-2">
...
<div class="container mt-1 mb-3">
<h2 class="font-weight-light section-heading h2title">Productos recien agregados</h2>
<div class="row mx-auto my-auto text-center">
    <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
        <div class="carousel-inner esp w-100" role="listbox">
            <?php foreach ($this->productDao->listRecentlyAddedProducts() as $index => $p) { ?>
...
<div class="row">
    <div class="col">
        <h2 class="font-weight-light section-heading h2title">Jean</h2>
    </div>
    <div class="col">
        <div class="float-right mt-2">
...
<div class="row">
    <div class="col">
        <h2 class="font-weight-light section-heading h2title">Jogger</h2>
    </div>
    <div class="col">
        <div class="float-right mt-2">
...
<div class="row">
    <div class="col">
        <h2 class="font-weight-light section-heading h2title">Short</h2>
    </div>
    <div class="col">
        <div class="float-right mt-2">
